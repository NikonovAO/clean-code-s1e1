...
var taskInput=document.getElementById("task-new__input");//Add a new task.
var addButton=document.getElementById("task__add");//first button
var incompleteTaskHolder=document.getElementById("task__incomplete");//ul of #incompleteTasks
var completedTasksHolder=document.getElementById("task__completed");//completed-tasks
...
//select ListItems children
    var checkBox=taskListItem.querySelector(".task__mark-complete");
