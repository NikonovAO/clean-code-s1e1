...
const taskInput=document.getElementById('task-new__input');//Add a new task.
const addButton=document.getElementById('task__add');//first button
const incompleteTaskHolder=document.getElementById('task__incomplete');//ul of #incompleteTasks
const completedTasksHolder=document.getElementById('task__completed');//completed-tasks
